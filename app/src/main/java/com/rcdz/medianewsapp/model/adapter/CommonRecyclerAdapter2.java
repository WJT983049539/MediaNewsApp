...
public abstract class CommonRecyclerAdapter2<T> extends RecyclerView.Adapter<CommonViewHolder> {
    ...
    public CommonRecyclerAdapter2(Context context, List<T> data, int layoutId) {
     ...
     * 多布局支持
     */
    public CommonRecyclerAdapter2(Context context, List<T> data, MultiTypeSupport<T> multiTypeSupport) {
        this(context, data, -1);
    ...
    public void onBindViewHolder(CommonViewHolder holder, final int position) {
        ...
        // 绑定怎么办？回传出去
        convert(holder,mContext, mData.get(position),position);
    }
     ...
     * @param item 当前的数据
     */
    public abstract void convert(CommonViewHolder holder,Context context, T item,int position);
