package com.rcdz.medianewsapp.view.pullscrllview;
...
import com.rcdz.medianewsapp.view.pullscrllview.dirview.AppBarStateChangeListener;
import com.rcdz.medianewsapp.view.pullscrllview.dirview.ArrowRefreshHeader;
import com.rcdz.medianewsapp.view.pullscrllview.dirview.LoadingMoreFooter;
import com.rcdz.medianewsapp.view.pullscrllview.dirview.ProgressStyle;
import com.rcdz.medianewsapp.view.pullscrllview.interfaces.CustomFooterViewCallBack;
...
//                Log.e("onLoadTop:","pullRefreshEnabled:"+pullRefreshEnabled+" "+(mRefreshHeader.getState() < ArrowRefreshHeader.STATE_REFRESHING)+" isLoadingData:"+isLoadingData);
