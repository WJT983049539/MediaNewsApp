...
public class SmoothCheckBox extends View implements View.OnClickListener {
    ...
    public SmoothCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = a.getInt(R.styleable.SmoothCheckBox_duration, 200);
        ...
        defaultTickWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics());
        mTickWidth = a.getDimension(R.styleable.SmoothCheckBox_tickWidth, defaultTickWidth);
        borderColor = a.getColor(R.styleable.SmoothCheckBox_borderColor, getResources().getColor(R.color.colordd));
        trimColor = a.getColor(R.styleable.SmoothCheckBox_trimColor, getResources().getColor(android.R.color.holo_red_light));
