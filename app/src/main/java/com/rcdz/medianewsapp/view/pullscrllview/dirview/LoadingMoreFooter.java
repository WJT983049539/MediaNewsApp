package com.rcdz.medianewsapp.view.pullscrllview.dirview;
...
import com.rcdz.medianewsapp.view.pullscrllview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView() {
        ...
        layoutParams.setMargins((int) getResources().getDimension(R.dimen.dp_10), (int) getResources().getDimension(R.dimen.dp_10), 0, (int) getResources().getDimension(R.dimen.dp_10));
